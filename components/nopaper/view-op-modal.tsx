// components/nopaper/view-op-modal.tsx
import {
    Dialog,
    DialogContent,
    DialogHeader,
        ...
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">{order.tipoLancamento}</p>
                </div>
                <div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm">{order.formaPagamento}</p>
                </div>
                <div>
              ...
              <div className="space-y-2">
                {order.itens?.map((item: any, index: number) => (
                  <div key={index} className="border p-2 rounded">
                    ...
                    <p className="text-sm">
                      <span className="font-medium">Valor:</span> R$ {item.valor}
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {order.centrosCusto?.map((centro: any, index: number) => (
                  <div key={index} className="border p-2 rounded">
                    <p className="text-sm">
                    ...
                    <p className="text-sm">
                      <span className="font-medium">Valor:</span> R$ {centro.valor}
                    </p>
                  </div>
                ))}
              </div>
